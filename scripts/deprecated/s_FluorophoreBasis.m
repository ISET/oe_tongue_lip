...
plot(wave, collagen.emission/max(collagen.emission(:)),'r','LineWidth',2); hold on;
collagen = fiReadFluorophore('CollagenWuQu.mat','wave',wave); 
plot(wave, collagen.emission/max(collagen.emission(:)),'g','LineWidth',2);
collagen = fiReadFluorophore('CollagenPalero.mat','wave',wave);
plot(wave, collagen.emission/max(collagen.emission(:)),'b','LineWidth',2); hold on;
collagen = fiReadFluorophore('CollagenMonici.mat','wave',wave);
plot(wave, collagen.emission/max(collagen.emission(:)),'m','LineWidth',2); hold on;
collagen = fiReadFluorophore('CollagenAlfano.mat','wave',wave);
