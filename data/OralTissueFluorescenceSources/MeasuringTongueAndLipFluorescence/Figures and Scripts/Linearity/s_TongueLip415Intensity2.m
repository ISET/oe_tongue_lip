...
% Linearity for other lights and subjects
% JF (/Users/joyce/Library/CloudStorage/GoogleDrive-jefarrel@stanford.edu/My Drive/Projects/Oral Cancer Screening/Spectral Data/Lab Measurements/2024-03-12)
% zlv (/Users/joyce/Library/CloudStorage/GoogleDrive-jefarrel@stanford.edu/My Drive/Projects/Oral Cancer Screening/Spectral Data/Lab Measurements/2024-03-14)
% BW and df
% (/Users/joyce/Library/CloudStorage/GoogleDrive-jefarrel@stanford.edu/My Drive/Projects/Oral Cancer Screening/Spectral Data/Lab Measurements/2024-03-19)
% /Users/joyce/Library/CloudStorage/GoogleDrive-jefarrel@stanford.edu/My Drive/Projects/Oral Cancer Screening/Spectral Data/Lab Measurements/2024-03-08 (415nm tongue+lip)
%   

%% Zhenyi 
% tongue (we do not plot the data for 170 mA so that we can compare with
% the other subjects
...
Z_tongue = ieReadSpectra('spd-2024-03-07-Z-Tongue-415nm450SPF-460mA-R01.mat',waves);	plot(waves,Z_tongue,'g','LineWidth',2); hold on;
% Z_tongue = ieReadSpectra('spd-2024-03-07-Z-Tongue-415nm450SPF-460mA-R02.mat',waves);	plot(waves,Z_tongue,'g','LineWidth',2); hold on;
% two successive measurements are very different
Z_tongue = ieReadSpectra('spd-2024-03-07-Z-Tongue-415nm450SPF-910mA-R01.mat',waves);    plot(waves,Z_tongue,'r','LineWidth',2); hold on; 
% Z_tongue = ieReadSpectra('spd-2024-03-07-Z-Tongue-415nm450SPF-910mA-R02.mat',waves);    plot(waves,Z_tongue,'r','LineWidth',2); hold on;
