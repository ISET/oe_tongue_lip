function [global_params, weights, finalFluorophores] = oeSolveJoint(wave, data, fixedFluorophores)
% oeSolveJoint - Fits a fixed matrix to joint lip and tongue data.
%
% Synopsis
%   [global_params, weights, finalFluorophores] = oeSolveJoint(wave, data, fixedFluorophores)
%
% Brief Description
...
%  density.  We then add an extra column that is a skewedGaussian.  We
%  search for the skewed Gaussian parameters.
%
% Inputs:
